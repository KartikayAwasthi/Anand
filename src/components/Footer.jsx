        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          >
            <img
              ...
              alt="Anand Bhasker Logo"
              className="w-36 mb-4 brightness-110"
            />
            <p className="text-gray-300 mb-6 max-w-md leading-relaxed">
              Senior Flutter Developer passionate about building robust mobile
              applications. Bringing 4+ years of enterprise experience and
              leadership in delivering seamless user experiences.
            </p>
            <motion.button
          ...
          >
            <p className="text-sm text-gray-400 text-center mt-10 tracking-wide">
              ...
              <span
                onClick={() =>
                  window.open(
                    "https://www.linkedin.com/in/KartikayAwasthi/",
                    "_blank"
                  )
                }
